						...
						<form id="saveProperty"
								...
								<div class="row g-4">
									...
									<div class="col-md-6">
										...
										<input type="text" id="ownerName" name="ownerName"
											class="form-control" value="${property.ownerName}"
									...
									<div class="col-md-3">
										...
										<input type="text" id="mobile" name="mobile"
											value="${property.mobile}" class="form-control"
									...
									<div class="col-md-3">
										<label class="form-label"><spring:message
											...
											value="${property.propertyNo}" class="form-control" readonly required
									...
									<div class="col-md-3">
										...
										<select id="propertyType" name="propertyType"
											...
											<c:forEach var="t" items="${types}">
												<option value="${t.propertyType}"
													<c:if test="${t.propertyType == property.propertyType}">selected</c:if>>
													${t.propertyType}</option>
											</c:forEach>
									...
									<div class="col-md-3">
										...
										<input type="text" id="wardNo" name="wardNo"
											value="${property.wardNo}" class="form-control"
							...
							<div class="d-flex flex-wrap justify-content-center gap-2 mt-4">
								<button type="submit" id="submitBtn"
									...
									💾
									<spring:message code="propertyType.update_property" />
								</button>

								<a href="${pageContext.request.contextPath}/propertyList"
									class="btn btn-secondary px-4"> 🔙 <spring:message
										code="propertyType.cancel" />
								</a>
							</div>
