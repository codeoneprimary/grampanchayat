...
<spring:message code="header.animal_husbandry_department" var="pageTitle" />
		...
		<div id="header-carousel" class="carousel slide"
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item active">
					<img
						src="${pageContext.request.contextPath}/resources/img/pashuVibhag/pashuVibhag01.jpeg"
						alt="Image">
				</div>

				<div class="carousel-item">
					<img
						src="${pageContext.request.contextPath}/resources/img/pashuVibhag/pashuVibhag02.jpeg"
						alt="Image">
				</div>
			</div>
