		...
		<div id="header-carousel" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img
						src="${pageContext.request.contextPath}/resources/img/topImages/narayanBetMandir.jpeg"
						alt="Image">
				</div>
			</div>
			...
			<div class="row g-5">
				<div class="col-lg-4 col-md-5 wow fadeInUp">
					<img class="img-fluid rounded" data-wow-delay="0.1s"
						src="${pageContext.request.contextPath}/resources/img/narayan_Maharaj.jpeg">
				</div>
