...
<head>
<meta charset="utf-8">
<title><spring:message code="header.administrative_structure" /></title>
		...
		<div class="container" style="text-align: justify;">
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<p>
						<b><spring:message code="administrativeStructure.para1" /></b>
					</p>
					<p>
						<b><spring:message code="administrativeStructure.para2" /></b>
					</p>
					<p>
						<b><spring:message code="administrativeStructure.para3" /></b>
					</p>
					<br/>
