...
<spring:message code="header.objectives_functions" var="pageTitle" />
		...
		<div class="container" style="text-align: justify;">
			<div class="row g-5">
				...
				<div class="col-lg-12 col-md-12">
					...
					<p>
						<spring:message code="objectivesAndFunctions.para3" />
					</p>
					<p>
						<spring:message code="objectivesAndFunctions.para4" />
					</p>
					<p>
						<spring:message code="objectivesAndFunctions.para5" />
					</p>
				</div>
			</div>
		</div>
